from common import np, device ,data,torch,det_args,os,DEBUG
from detector.model import SegDetectorModel,train_processes
from detector.preprocess import ImageDataset        
# 学习率调整方法
